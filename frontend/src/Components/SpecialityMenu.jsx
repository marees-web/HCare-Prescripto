...
import { specialityData } from '../assets/frontendass/assetts'
import { Link } from 'react-router-dom'
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
      <h1 className='text-3xl font-bold'>Find by speciality</h1>
      <p className='text-sm sm:w-1/3 text-center'>Simply browse through our extensive list of doctors,Schedule your appoinments hassle-free</p>

...
const AllApointments = () => {
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      <p className='mb-3 text-2xl font-medium  bg-primary text-white px-6 py-3 w-full  rounded'>All Appointments</p>
      <div className='bg-white border rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>
        ...
        {appointments.map((item,index)=>(
          <div className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-100 ' key={index}>
              ...
              <div className='flex items-center gap-2'>
                <img className='w-8 rounded-full bg-gray-600' src={item.docData.image} alt="" /> <p>{item.docData.name}</p>
              </div>
